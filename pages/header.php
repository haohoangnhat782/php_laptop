        ...
        <div class="top-header">
            <div class="container">
                <div class="menu-store">
                    <div class="logo-site">
                        <a href="index.php">
                            <img src="/php_laptop/images/site-logo.svg" class="logo" alt="logo">
                        </a>
                    </div>
                    <div class="menu-center">
                        <div class="dropdown">
                            <button class="cate-btn btn" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu">
                                <?php while ($row = mysqli_fetch_array($query_dm)) { ?>
                                    <li><a href="index.php?quanly=danhmucsanpham&id=<?php echo $row['id_danh_muc'] ?>" class="dropdown-item">
                    ...
                    <div class="right-menu">
                        ...
                        <div class="member-btn" title="Thành viên - Đăng ký - Đăng nhập"><a href="<?php if (isset($_SESSION["login"])) {
                                                                                                        echo "index.php?quanly=profile";
                                                                                                    } else {
                                                                                                        echo "index.php?quanly=authenticate";
                                                                                                    } ?>">
