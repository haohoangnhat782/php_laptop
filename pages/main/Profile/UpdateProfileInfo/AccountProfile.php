         ...
         <form>
             <?php for ($i = 0; $i < 3; $i++) : ?>
                 <div class="box-user">
                     ...
                     <input type="text" id="input<?php echo $i ?>" class="form-control" placeholder="<?php echo $placeholders[$i] ?>" value="<?php if ($isUserInfo) ?>">
                 </div>
             <?php endfor; ?>
             <div class="box-user box-submit">
                 <button type="button" class="profile-update-btn">Cập nhật</button>
             </div>
         </form>
     </div>
 </body>