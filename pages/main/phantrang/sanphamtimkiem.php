...
$offset = ($page - 1) * $so_sp;
$tukhoa = $_GET['tukhoa'];
$sql_pro = "SELECT * FROM san_pham, danh_muc WHERE san_pham.ma_danh_muc = danh_muc.id_danh_muc and san_pham.trang_thai=1 AND san_pham.ten_san_pham LIKE '%" . $tukhoa . "%' ORDER BY san_pham.id_san_pham DESC LIMIT $offset, $so_sp";
